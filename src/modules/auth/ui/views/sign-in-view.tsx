        ...
        <CardContent className="grid p-0">
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="p-6 md:p-8">
              ...
              <Button disabled={isLoading} type="submit" className="w-full [background-image:var(--primary-gradient)]">Sign in</Button>
              <div className="after:border-border relative text-center text-sm after:absolute after:inset-0 after:top-1/2 after:z-0 after:flex after:items-center after:border-t">
               ...
               <div className="text-center text-sm">
                <p>
                    Don't have an account? <Link href="/sign-up" className="font-medium underline underline-offset-4">Sign up</Link>
                </p>
